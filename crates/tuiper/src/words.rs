...
pub fn generate_words_text(seed: u64, _value: u32, total_words: u32) -> Option<String> {
    let word_list = words();
...
pub fn generate_next_chunk(seed: u64, _value: u32, words_so_far: u32) -> Option<String> {
    let word_list = words();
